...
Phase-Field Modeling · Materials Informatics · Thermodynamic Tensor Models · Nuclear Materials

🌐 [subediupadesh.github.io](https://subediupadesh.github.io) ·
🎓 [Google Scholar](https://scholar.google.com/citations?user=wW5dA0sAAAAJ&hl=en) ·
🔗 [ORCID](https://orcid.org/0000-0002-5527-1348) ·
💼 [LinkedIn](https://www.linkedin.com/in/upadesh-s-0b321a15b/) ·
🧪 [ResearchGate](https://www.researchgate.net/profile/Upadesh-Subedi)
...
- **[pyMPEALab](https://github.com/subediupadesh/pyMPEALab)** — Python toolkit for predicting
  phases of multi-principal element alloys using neural networks.
- **[IMCATHEA](https://github.com/subediupadesh/IMCATHEA)** — GUI application for detecting
  intermetallic phases in HEA/MPEA systems using neural networks.

---

<div align="center">
This repository hosts the source code for my personal website, built with plain HTML, CSS, and JavaScript.
<br>
Maintenance notes for editing the site live in <a href="GUIDE.md">GUIDE.md</a>.
</div>
